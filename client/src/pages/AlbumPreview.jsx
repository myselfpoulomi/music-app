...
function AlbumPreview() {
  return (
    <div className="bg-[rgba(31,18,18,0.2)] h-[100vh] w-[100%]">
      <div className="bg-[rgba(31,18,18,0.4)] w-[100%] h-[300px] flex items-center pl-[20px] gap-[2rem]">
        <img
          className="h-[200px] w-[200px] rounded-lg"
          src="https://m.media-amazon.com/images/I/A15zRpb+JwL._UF1000,1000_QL80_.jpg"
          alt=""
        />
      ...
      <h1 className="text-white text-[25px] my-[10px] ml-[30px]">Songs :</h1>
        {
